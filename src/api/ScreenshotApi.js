...
export class ScreenshotApi {
    ...
    */
    ...
    captureScreenshotAuthenticated(token, hash, url, opts, callback) {
      ...
      let queryParams = {
        'url': url,'fileType': opts['fileType'],'ttl': opts['ttl'],'invalidate': opts['invalidate'],'full': opts['full'],'lazyload_scroll': opts['lazyloadScroll'],'delay': opts['delay'],'width': opts['width'],'height': opts['height'],'quality': opts['quality'],'scale': opts['scale'],'x': opts['x'],'y': opts['y'],'redirect': opts['redirect'],'language': opts['language'],'random_user_agent': opts['randomUserAgent'],'user_agent': opts['userAgent'],'headers': opts['headers'],'cookies': opts['cookies'],'css': opts['css'],'js': opts['js'],'wait': opts['wait'],'element': opts['element'],'timezone': opts['timezone'],'device': opts['device'],'latitude': opts['latitude'],'longitude': opts['longitude'],'accuracy': opts['accuracy'],'proxy': opts['proxy'],'adblock': opts['adblock'],'hide_cookie_banners': opts['hideCookieBanners']
      };
      let headerParams = {
      ...
      let authNames = [];
      let contentTypes = [];
      let accepts = ['application/json', 'application/pdf', 'image/jpeg', 'image/png', 'image/webp'];
      let returnType = 'Blob';

      return this.apiClient.callApi(
        '/capture/{token}/{hash}', 'GET',
